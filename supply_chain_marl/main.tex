...
balance non-linearity from data, incurring higher sample complexity---which is precisely
what explicit CCD pre-computation avoids.
...
concentrates on demand-side disruptions (S1: 10.1\%; S4: 4.0\%) but nearly vanishes
