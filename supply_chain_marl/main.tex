...
motivating our compound-shock scenario.  \citet{dolgui2021ripple} study ripple cascades
in supply networks; their analysis of how local failures spread chain-wide informs our
choice of bullwhip penalty in the reward function.
...
cooperative benchmarks.  \citet{papoudakis2021benchmarking} benchmark Independent PPO
(IPPO)---a fully decentralized PPO variant with no shared critic---and demonstrate that
it remains a competitive baseline in cooperative tasks despite its simplicity.
...
provide the first representational-efficiency argument for embedding CCD directly in the
state---additive functions $\alpha B+\beta D$ cannot capture the balance non-linearity that
CCD encodes (Proposition~1)---and a controlled ablation that tests this claim empirically.
